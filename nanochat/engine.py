...
class RoutingLoopKVCache:
    """Two normal KV caches, one for each causal pass."""
    def __init__(self, *args, **kwargs):
        self.pass1 = KVCache(*args, **kwargs)
        self.pass2 = KVCache(*args, **kwargs)
    ...
    def get_pos(self):
        assert self.pass1.get_pos() == self.pass2.get_pos()
        return self.pass1.get_pos()

    def prefill(self, other):
        self.pass1.prefill(other.pass1)
        self.pass2.prefill(other.pass2)
